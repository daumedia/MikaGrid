...
struct PermissionScreen: View {
    // Nimmt seit Feature 01 die beiden Teile entgegen, die es wirklich braucht, statt den
    // ganzen `AppState`: Der Schritt gehört zur Direktfassung, `AppState` liegt in der
    // gemeinsamen Bibliothek und kennt den `AccessibilityManager` nicht mehr.
    ...
    private var isGranted: Bool { accessibilityManager.isGranted }
