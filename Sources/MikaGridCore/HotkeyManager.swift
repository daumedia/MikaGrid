...
public final class HotkeyManager {
    ...
    public private(set) var currentBindings: [SnapAction: HotkeyBinding]
    ...
    public private(set) var failedRegistrations: Set<SnapAction> = []

    public init(onSnap: @escaping @MainActor (SnapAction) -> Void, savedBindings: [SnapAction: HotkeyBinding]? = nil) {
        self.onSnap = onSnap
    ...
    public func reRegisterAll(bindings: [SnapAction: HotkeyBinding]) {
        unregisterAll()
    ...
    public static func keyCodeToString(_ keyCode: UInt32) -> String {
        hotkeyKeyCodeToString(keyCode)
    }

    public static func modifiersToSymbols(_ modifiers: UInt32) -> String {
    ...
    public static func defaultBindings() -> [SnapAction: HotkeyBinding] {
    ...
    public static func loadBindings(from defaults: UserDefaults = .standard) -> [SnapAction: HotkeyBinding] {
